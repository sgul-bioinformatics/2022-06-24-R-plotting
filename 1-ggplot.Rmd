...
* load the dataset stored in `/data.csv`, plot a bar chart of `county` against `popadults` for the state of Ohio (OH)
...
* Using the same dataset, calculate the total and generate  a scatter plot of `area` against `poptotal` 
...
* We can easily perform heirarchical clustering on a dataset and then draw a tree
