...
* load the dataset stored in `/data.csv`, plot a bar chart of `county` against `popadults`, but plot for all states
...
data %>%
  ggplot(aes(x=county, y=popadults, group=state, color=category)) +
    geom_point() +
